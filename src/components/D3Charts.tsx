      ...
      g.append('circle')
        ...
        .on('mouseover', function(event) {
          d3.select('body').append('div')
            ...
            .style('font-size', '12px')
            .style('pointer-events', 'none')
            .html(`<strong>${safeT('dashboard.charts.axisLabels.cumulativeEntries', 'Cumulative Entries')}</strong><br/>${safeT('common.date', 'Date')}: ${d[0].toLocaleDateString('fr-FR')}<br/>${safeT('common.total', 'Total')}: ${cumulativeEntrees.toFixed(1)}t<br/>${safeT('deliveries.charts.daily', 'Daily')}: ${dailyEntrees.toFixed(1)}t<br/>${safeT('deliveries.banners.netBalance', 'Balance')}: ${netStock.toFixed(1)}t`)
            .style('left', (event.pageX + 10) + 'px')
            .style('top', (event.pageY - 10) + 'px')
            .style('opacity', 0)
      ...
      g.append('circle')
        ...
        .on('mouseover', function(event) {
          d3.select('body').append('div')
            ...
            .style('font-size', '12px')
            .style('pointer-events', 'none')
            .html(`<strong>${safeT('dashboard.charts.axisLabels.cumulativeExits', 'Cumulative Exits')}</strong><br/>${safeT('common.date', 'Date')}: ${d[0].toLocaleDateString('fr-FR')}<br/>${safeT('common.total', 'Total')}: ${cumulativeSorties.toFixed(1)}t<br/>${safeT('deliveries.charts.daily', 'Daily')}: ${dailySorties.toFixed(1)}t`)
            .style('left', (event.pageX + 10) + 'px')
            .style('top', (event.pageY - 10) + 'px')
            .style('opacity', 0)
            .transition().duration(200).style('opacity', 1)
      ...
      g.append('circle')
        ...
        .on('mouseover', function(event) {
          d3.select('body').append('div')
            ...
            .style('font-size', '12px')
            .style('pointer-events', 'none')
            .html(`<strong>${safeT('dashboard.charts.axisLabels.netStock', 'Net Stock')}</strong><br/>${safeT('common.date', 'Date')}: ${d[0].toLocaleDateString('fr-FR')}<br/>${safeT('deliveries.banners.netBalance', 'Balance')}: ${netStock.toFixed(1)}t`)
            .style('left', (event.pageX + 10) + 'px')
            .style('top', (event.pageY - 10) + 'px')
            .style('opacity', 0)
            .transition().duration(200).style('opacity', 1)
        ...
        g.append('circle')
          ...
          .on('mouseover', function(event) {
            d3.select('body').append('div')
              ...
              .style('font-size', '12px')
              .style('pointer-events', 'none')
              .html(`<strong>${safeT('deliveries.table.humidity', 'Humidity')}</strong><br/>${safeT('common.date', 'Date')}: ${d[0].toLocaleDateString('fr-FR')}<br/>${safeT('deliveries.table.humidity', 'Humidity')}: ${d[1].humidite.toFixed(1)}%`)
              .style('left', (event.pageX + 10) + 'px')
              .style('top', (event.pageY - 10) + 'px')
              .style('opacity', 0)
              .transition().duration(200).style('opacity', 1)
